...
<html lang="en">
    ...
    <head>
        ...
        <title>Online Borrowing Book System</title>
            ...
            <div class="navbar-inner">
                <div class="container">
                    <a class="btn btn-navbar" data-toggle="collapse" data-target=".navbar-inverse-collapse">
                        <i class="icon-reorder shaded"></i></a><a class="brand" href="index.php">Online Borrowing Book System </a>
                    ...
                    <div class="span3">
                        <div class="sidebar">
                            <ul class="widget widget-menu unstyled">
                                ...
                                <li><a href="reports.php"><i class="menu-icon icon-list"></i>Reports </a></li>
                            </ul>
                            <ul class="widget widget-menu unstyled">
...
<div class="footer">
            <div class="container">
                <b class="copyright">&copy; 2025 Online Borrowing Book System </b>All rights reserved.
            </div>
        </div>
